        ...
        <>
            <div className="py-5 mx-auto" style={{ width: '80%' }}>
                ...
                <div className="d-flex align-items-center justify-content-between mt-5 mb-2 py-2 px-2 rounded" style={{ backgroundColor: 'rgb(201, 197, 197)' }}>
                    ...
                    <Link to="/admin/categories/create" className="btn btn-primary me-1" data-mdb-ripple-color="dark" style={{ width: 'fit-content !important' }}>Create Category</Link>
                </div>
                <div className="row">
                    {
                                ...
                                <div className="card text-black">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex flex-row">
                                            <Link to={`update/${category.category_id}`} className="btn btn-primary flex-fill me-1 mx-1" data-mdb-ripple-color="dark">update</Link>
